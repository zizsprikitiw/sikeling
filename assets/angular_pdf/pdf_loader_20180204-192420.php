...
<script type="text/javascript">				
	...
	app.controller('DocCtrl', function($scope) {
		  ...
		  $scope.pdfName = '';
		  $scope.pdfUrl = 'http://proyek2.pustekbang.go.id/pustekbang_file_archive/log/95/LAPORAN_PERJADIN_Diskusi_Bersama_Tim_FTC_PT.DI_terkait_OC_91_dan_pemanfaatan_bersama_pesawat_Cessna_172.pdf';
		  $scope.scroll = 0;
