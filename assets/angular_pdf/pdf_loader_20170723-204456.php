...
<script type="text/javascript">				
	...
	app.controller('DocCtrl', function($scope) {
		  ...
		  $scope.pdfName = '';
		  $scope.pdfUrl = 'http://proyek2.pustekbang.go.id/pustekbang_file_archive/log/120/Laporan_Triwulan_I-2017-Tri_Widodo-Koord_Humas_dan_Publikasi-24_Maret_2017.pdf';
		  $scope.scroll = 0;
