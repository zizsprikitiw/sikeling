...
<script type="text/javascript">				
	...
	app.controller('DocCtrl', function($scope) {
		  ...
		  $scope.pdfName = '';
		  $scope.pdfUrl = 'http://proyek2.pustekbang.go.id:81/pustekbang_file_archive/log/22/Logbook___Laporan_Kegiatan_Bulan_Februari_-_2018_-_Natanael_M_Rev_1_20180304-235434.pdf';
		  $scope.scroll = 0;
