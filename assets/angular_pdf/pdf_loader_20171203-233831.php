...
<script type="text/javascript">				
	...
	app.controller('DocCtrl', function($scope) {
		  ...
		  $scope.pdfName = '';
		  $scope.pdfUrl = 'http://proyek2.pustekbang.go.id/pustekbang_file_archive/50/4/81/laporan_4_TN_LAPORAN_HASIL_KEGIATAN_PENGEMBANGAN_LAB.RTCA_DO_160_G_2017,NOP.pdf';
		  $scope.scroll = 0;
