...
<script type="text/javascript">				
	...
	app.controller('DocCtrl', function($scope) {
		  ...
		  $scope.pdfName = '';
		  $scope.pdfUrl = 'http://proyek2.pustekbang.go.id/pustekbang_file_archive/50/4/140/LSU02NGLD_WP2200_Structural_Sizing_Fuselage_Stress_Calculation_ES2.8_TN04.pdf';
		  $scope.scroll = 0;
