	...
	<form class="form-horizontal" method="post">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<option></option>
					<?php
						$cat_query = mysql_query("select * from status_login");
						while($cat_row = mysql_fetch_array($cat_query)){
					?>
						<option value="<?php echo $cat_row['classname']; ?>"><?php echo $cat_row['classname']; ?></option>
						<?php  } ?>
					</select>
				</div>
			</div>
	...
	mysql_query("insert into users (username,password,firstname,lastname,status) values('$username','$password','$firstname','$lastname','$status')")or die(mysql_error());
	}
