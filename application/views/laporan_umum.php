  	...
  	<div class="mainbar" >      
			...
			<div class="container" >								
				...
				<div class="row">
					...
					<div class="col-md-2" align="right">
						...
						<button class="btn btn-success" onClick="data_add()"><i class="fa fa-plus"></i> Input Laporan Umum</button>	
					</div>									
				</div>
		...
		<script type="text/javascript">		
			...
			function load_select_filter(){
				 $.ajax({
						url : "<?php echo site_url('laporan_umum/data_init/')?>" ,
						type: "POST",
						dataType: "JSON",
			...
			$(document).ready(function() {								  			
				...
				$("#modalLaporan").bind("hidden.bs.modal", function(e){
					...
					$.ajax({
							url : "<?php echo site_url('laporan_umum/show_laporan_delete')?>",
							type: "POST",
							dataType: "JSON",
							data: form_data,
							success: function(data)
				...
				//load data table																
			 	table = $('#table').DataTable({ 			
					...
					"ajax": {
						"url": "<?php echo site_url('laporan_umum/data_list')?>",
						"type": "POST",						
						"data": function ( d ) {
			...
			{					 								  
			  ...
			  form_data.append("file_laporan", file);						  				  					  				  					  
			   ...
			   // ajax adding data to database
				  $.ajax({
					url : "<?php echo site_url('laporan_umum/data_save_validation/')?>",
					type: "POST",
					data: form_data,
					processData: false,
					contentType: false,
			  ...
			  $('#new_filename').html(new_file_name);
			   ...
			   // ajax adding data to database
				  $.ajax({
					...
					url : "<?php echo site_url('laporan_umum/data_save_logbook/')?>",
					type: "POST",
					data: form_data,
					processData: false,
					contentType: false,
			...
			{				 				
				...
				$.ajax({
						url : "<?php echo site_url('laporan_umum/show_laporan')?>",
						type: "POST",
						dataType: "JSON",
						data: form_data,
						success: function(data)
