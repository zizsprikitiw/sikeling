  	...
  	<div class="mainbar" >      
		...
		<script type="text/javascript">	
			...
			function load_select_filter(){
				 $.ajax({
						url : "<?php echo site_url('berita_rekap/data_init/')?>" ,
						type: "POST",
						dataType: "JSON",
			...
			$(document).ready(function() {									  			
				...
				//load data table																
			 	table = $('#table').DataTable({ 			
					...
					"ajax": {
						"url": "<?php echo site_url('berita_rekap/data_list')?>",
						"type": "POST",						
						"data": function ( d ) {
			...
			{			  				  
			  ...
			  $.ajax({			  		
					url : "<?php echo site_url('berita_rekap/data_edit/')?>/" + id,
					type: "GET",
					dataType: "JSON",
					success: function(data)
					{				   
			...
			{					 								  
			  ...
			  form_data.append("file_gambar", file);
			   ...
			   // ajax adding data to database
				  $.ajax({
					url : "<?php echo site_url('berita_rekap/data_save_validation/')?>",
					type: "POST",
					data: form_data,
					processData: false,
					contentType: false,
			...
			{					 								  
			  ...
			  if(save_method == 'add') 
			  {
				  url = "<?php echo site_url('berita_rekap/data_save_add_berita/')?>";
			  }
			  else
			  {
				url = "<?php echo site_url('berita_rekap/data_save_edit_berita')?>";
			  }
			...
			{										
			  //Ajax Load data from ajax
			  $.ajax({			  		
					url : "<?php echo site_url('berita_rekap/detail_berita/')?>/" + id_berita,
					type: "GET",
					dataType: "JSON",
					success: function(data)
					{				   
