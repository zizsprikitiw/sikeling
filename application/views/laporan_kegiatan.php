  	...
  	<div class="mainbar" >      
			...
			<div class="container" >								
				...
				<div class="row">
					<div class="col-sm-12 form-horizontal" align="left">
							...
							<div class="form-group" style="vertical-align:middle">
								<label class="col-sm-2 checkbox-inline" style="max-width:150px; padding-left:40px; vertical-align:middle;"><b>
								  <input type="checkbox" name="chkSearch[]" id="chkSearch[]" value="jenis"> Jenis laporan:</b>
								</label>
								<div class="col-sm-3" align="left" style="text-align:left;  padding-left:0px; ">                               
									<select name="jenis_laporan" id="jenis_laporan" class="form-control" style="max-width:160px;">
								...
								<label class="col-sm-2 checkbox-inline" style="max-width:100px; padding-left:0px; vertical-align:middle;"><b>
								  <input type="checkbox" name="chkSearch[]" id="chkSearch[]" value="judul"> Judul laporan:</b>
								</label>							
								<div class="col-sm-5" align="left" style="text-align:left; padding-left:0px; ">                               
									<input type="text" class="form-control" id="judul" name="judul" placeholder="Judul kegiatan" >
								</div>														
							</div>
							
							<div class="form-group" style="vertical-align:middle">
								<label class="col-sm-2 checkbox-inline" style="max-width:150px; padding-left:40px; vertical-align:middle;"><b>
								  <input type="checkbox" name="chkSearch[]" id="chkSearch[]" value="kegiatan"> Kegiatan</b>
								</label>								
								<div class="col-sm-2" align="left" style="text-align:left; padding-left:0px; padding-right:0px">                               
									<select name="filter_pusat" id="filter_pusat" class="form-control" style="max-width:200px;" >
										<option value="0" >-- Pilih --</option>
									</select> 
								</div>	
								<div class="col-sm-8" align="left" style="text-align:left; padding-left:10px;">  
						...
						<table class="table-hover table-bordered " cellpadding="0" cellspacing="0" border="0" id="table" width="100%">
							<thead style="background-color:#006699; color:#FFFFFF;">
								<tr>
								  ...
								  <th ><b>Judul</b></th>
								  <th style="min-width:180px"><b>Filename</b></th>
		...
		<script type="text/javascript">		
			...
			function load_select_filter(){
				 $.ajax({
					url : "<?php echo site_url('laporan_kegiatan/data_init/')?>" ,
					type: "POST",
					dataType: "JSON",
					success: function(data)
					{
						var item_sel=["filter_tahun", "filter_bulan", "filter_pusat"];
						var item_select = {"filter_tahun":-1, "filter_bulan":-1, "filter_pusat":-1};															
			...
			function load_filter_judul(){
				...
				if((select_tahun == '--Pilih--') | (select_tahun == '')){
					$('#ref_id').html('<Option value="0">--Pilih--</option>');						
				}else{
					//load data judul
					$.ajax({
						url : "<?php echo site_url('laporan_kegiatan/select_sub_judul/')?>" ,
						type: "POST",
						dataType: "JSON",
						data: form_data,
						success: function(data)
						{
							var item_sel=["filter_kegiatan"];
							var item_select = {"filter_kegiatan":-1};															
							select_box(data,item_select, item_sel);																																					
						},
						error: function (jqXHR, textStatus, errorThrown)
						{
			...
			$(document).ready(function() {								  			
				...
				$("#modalLaporan").bind("hidden.bs.modal", function(e){
					...
					$.ajax({
							url : "<?php echo site_url('laporan_masuk/show_laporan_delete')?>",
							type: "POST",
							dataType: "JSON",
							data: form_data,
							success: function(data)
				...
				//load data table																
			 	table = $('#table').DataTable({ 			
					...
					"ajax": {
						"url": "<?php echo site_url('laporan_kegiatan/data_list')?>",
						"type": "POST",						
						"data": function ( d ) {
								var chkSearch = [];
								...
								d.judul = document.getElementById('judul').value;							
								var item_selectbox = document.getElementById('filter_tahun');
								...
								var item_selectbox = document.getElementById('filter_kegiatan');
								d.filter_kegiatan = item_selectbox.options[item_selectbox.selectedIndex].value;	
			...
			{				 				
				...
				$.ajax({
						url : "<?php echo site_url('laporan_kegiatan/show_laporan')?>",
						type: "POST",
						dataType: "JSON",
						data: form_data,
						success: function(data)
