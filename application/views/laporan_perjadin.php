  	...
  	<div class="mainbar" >      
			...
			<div class="container" >								
				...
				<div class="row">
					...
					<div class="col-md-2" align="right">
						...
						<button class="btn btn-success" onClick="data_add()"><i class="fa fa-plus"></i> Input Laporan Perjadin</button>	
					</div>									
				</div>
		...
		<script type="text/javascript">		
			...
			function load_select_filter(){
				 $.ajax({
						url : "<?php echo site_url('laporan_perjadin/data_init/')?>" ,
						type: "POST",
						dataType: "JSON",
			...
			$(document).ready(function() {									  			
				...
				$("#modalLaporan").bind("hidden.bs.modal", function(e){
					...
					$.ajax({
							url : "<?php echo site_url('laporan_perjadin/show_laporan_delete')?>",
							type: "POST",
							dataType: "JSON",
							data: form_data,
							success: function(data)
				...
				//load data table																
			 	table = $('#table').DataTable({ 			
					...
					"ajax": {
						"url": "<?php echo site_url('laporan_perjadin/data_list')?>",
						"type": "POST",						
						"data": function ( d ) {
			...
			{			  				  
			  ...
			  document.getElementById('div_upload_status').style.display = "none";				  			  			  
				...
				//Ajax Load data from ajax
				  $.ajax({
						url : "<?php echo site_url('laporan_perjadin/data_add/')?>" ,
						type: "POST",
						dataType: "JSON",
						success: function(data)
						{
							//alert('ok');
							var item_sel=["klasifikasi_laporan"];
							var item_select = {"klasifikasi_laporan":-1};															
							select_box(data,item_select, item_sel);							
			...
			{					 								  
			  ...
			  var form_data = new FormData(form);				
				form_data.append("klasifikasi_laporan", document.getElementById('klasifikasi_laporan').value);
			  ...
			  form_data.append("file_laporan", file);						  				  					  				  					  
			   ...
			   // ajax adding data to database
				  $.ajax({
					url : "<?php echo site_url('laporan_perjadin/data_save_validation/')?>",
					type: "POST",
					data: form_data,
					processData: false,
					contentType: false,
			...
			{					 								  
			  ...
			  $('#new_filename').html(new_file_name);
			   ...
			   // ajax adding data to database
				  $.ajax({
					...
					url : "<?php echo site_url('laporan_perjadin/data_save_logbook/')?>",
					type: "POST",
					data: form_data,
					processData: false,
					contentType: false,
			...
			{				 				
				...
				$.ajax({
						url : "<?php echo site_url('laporan_perjadin/show_laporan')?>",
						type: "POST",
						dataType: "JSON",
						data: form_data,
						success: function(data)
				...
				<div class="modal-content">
					...
					<form class="form-horizontal" role="form" id="add_form" action="#" autocomplete="nope" enctype="multipart/form-data">
					  ...
					  <div class="modal-body">									  		 											
							...
							<div class="form-group">
							  <label class="col-lg-3 control-label" for="klasifikasi_laporan">Klasifikasi Laporan</label>
							  <div class="col-lg-7">									                             
									<select name="klasifikasi_laporan" id="klasifikasi_laporan" class="form-control" style="width:400px">
										<option value="" >-- Pilih --</option>
									</select> 									
							  </div>
							</div>
							...
							<div class="form-group">
							  ...
							  <div class="col-lg-9">
									<span class="btn btn-default btn-file"  style="width:100%">
										<input type="file"  id="file_laporan" name="file_laporan" placeholder="" >
									</span>									
							  </div>							  
							</div>	
