  	...
  	<div class="mainbar" >      
		...
		<script type="text/javascript">		
			...
			function load_select_filter(){
				 $.ajax({
					url : "<?php echo site_url('laporan_masuk/data_init/')?>" ,
					type: "POST",
					dataType: "JSON",
			...
			$(document).ready(function() {								  			
				...
				//load data table																
			 	table = $('#table').DataTable({ 			
					...
					"ajax": {
						"url": "<?php echo site_url('laporan_masuk/data_list')?>",
						"type": "POST",						
						"data": function ( d ) {
								var chkSearch = [];
			...
			{				 				
				...
				$.ajax({
					url : "<?php echo site_url('laporan_masuk/show_laporan')?>",
					type: "POST",
					dataType: "JSON",
					data: form_data,
					success: function(data)
			...
			function approval_laporan(id, nama, judul, note_id)
			{
				if(id != ''){
					...
					$.ajax({
							...
							{	
								pdf_file = 	data['note_filename_path'];																						
								document.getElementById('pdf_frame').src = data['note_filename_url'];																										
					...
					$.ajax({
						url : "<?php echo site_url('laporan_masuk/approval_laporan')?>/",
						type: "POST",
				...
				<div class="modal-content" >														
					  ...
					  <div class="modal-body" >
						...
						<form class="form-horizontal" role="form" id="approve_form" action="#">
					  		<input type="hidden" value="" name="id_note_inbox"/> 									
