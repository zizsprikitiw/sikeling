  	...
  	<div class="mainbar" >      
	    ...
	    <div class="matter" >
			<div class="container" >								
				...
				<button class="btn btn-success" onClick="data_add()"><i class="fa fa-plus"></i> Tambah Pusat</button>
				<br />
				<br />
				<!-- Table Page -->
						...
						<table class="table-hover table-bordered" cellpadding="0" cellspacing="0" border="0" id="table" width="100%">
							<thead style="background-color:#006699; color:#FFFFFF;">
								<tr>
								  ...
								  <th ><b>Nama Pusat</b></th>
								  <th ><b>Singkatan</b></th>
								  <th style="width:95px"><b>Aksi</b></th>
								</tr>
							</thead>													
						</table>						
						<div class="clearfix"></div>									
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {																
			 	table = $('#table').DataTable({ 			
					...
					"ajax": {
						"url": "<?php echo site_url('cms_pusat/data_list')?>",
						"type": "POST"
					},
			...
			function data_edit(id)
			{
			  ...
			  $.ajax({			  		
					url : "<?php echo site_url('cms_pusat/data_edit/')?>/" + id,
					type: "GET",
					dataType: "JSON",
			...
			function data_save()
			{
			  ...
			  if(save_method == 'add') 
			  {
				  url = "<?php echo site_url('cms_pusat/data_save_add')?>";
			  }
			  else
			  {
				url = "<?php echo site_url('cms_pusat/data_save_edit')?>";
			  }
			...
			function data_delete(id, nama_id)
			{
				if(id != ''){
					...
					$.ajax({
						url : "<?php echo site_url('cms_pusat/data_delete')?>/",
						type: "POST",
