  	...
  	<div class="mainbar" >      
						...
						<div class="col-md-7" align="left">
							<div class="form-group">
								...
								<div class="col-md-2">
									...
									<button class="btn btn-success" onClick="data_add()"><i class="fa fa-plus"></i> Tambah Kategori</button>	
								</div>		
						  	</div>										  													
						</div>																	
		...
		<script type="text/javascript">
			...
			function load_select_filter(){
				 $.ajax({
						url : "<?php echo site_url('cms_kategori/data_init/')?>" ,
						type: "POST",
						dataType: "JSON",
						success: function(data)
						{
							var item_sel=["filter_kategori"];
							var item_select = {"filter_kategori":-1};															
			...
			$(document).ready(function() {	
				...
				//load data table														
			 	table = $('#table').DataTable({ 			
					...
					"ajax": {
						"url": "<?php echo site_url('cms_kategori/data_list')?>",
						"type": "POST",						
						"data": function ( d ) {
								var item_selectbox = document.getElementById('filter_kategori');
								d.filter_kategori = item_selectbox.options[item_selectbox.selectedIndex].value;								
							}
					},
			...
			{			  				  
			  ...
			  $.ajax({			  		
					url : "<?php echo site_url('cms_kategori/data_add/')?>" ,
					type: "POST",
					dataType: "JSON",
					success: function(data)
					{				   
						var item_sel=["id_kategori"];
						var item_select = {"id_kategori":filter_kategori};															
						select_box(data,item_select, item_sel);			
			...
			function data_edit(id,id_kategori)
			{
			  save_method = 'update';
			  $('#add_form')[0].reset(); // reset form on modals
			  $('#modal_message').html('');  //reset message	
			  ...
			  //Ajax Load data from ajax
			  $.ajax({			  		
					url : "<?php echo site_url('cms_kategori/data_edit/')?>",
					type: "GET",
					dataType: "JSON",
					data: {
						id: id,
					...
					{				   
						...
						var item_sel=["id_kategori"];
						var item_select = {"id_kategori":data['filter_kategori']};		
						select_box(data,item_select, item_sel);						
			...
			function data_save()
			{
			  ...
			  var item_selectbox = document.getElementById('id_kategori');															  
			  form_data.append("id_kategori", item_selectbox.options[item_selectbox.selectedIndex].value);
				
			  if(save_method == 'add') 
			  {
				  url = "<?php echo site_url('cms_kategori/data_save_add')?>";
			  }
			  else
			  {
				url = "<?php echo site_url('cms_kategori/data_save_edit')?>";
			  }				
				...
				<div class="modal-content">
					...
					<form class="form-horizontal" role="form" id="add_form" action="#" autocomplete="nope">
					  ...
					  <div class="modal-body">									  		 											
						...
						<div class="form-group">
						  <label class="col-lg-3 control-label" for="id_kategori">Kategori</label>
						  <div class="col-lg-7">
						...
						<div class="form-group">
						  <label class="col-lg-3 control-label" for="nama_kategori">Nama Kategori</label>
						  <div class="col-lg-7">
