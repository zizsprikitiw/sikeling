...
<head>
  ...
  <!-- jQuery Select2 -->
  <link rel="stylesheet" href="<?=base_url()?>assets/bootstrap-calendar/css/bootstrap-year-calendar.min.css"> 
  ...
  <!-- Bootstrap PDF Viewer -->
	...
	<script src="<?php echo base_url('assets/bootstrap-3.3.7/js/bootstrap.min.js')?>"></script><!-- Bootstrap --> 
        ...
        <div class="col-md-4"  height="118px">
		  ...
		  <table id="Table_01" width="1000" height="118" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<img src="<?=base_url()?>assets/bootstrap/img/logo_1_02.png"  height="118" alt=""></td>
					<!-- <td> -->
