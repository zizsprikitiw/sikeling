...
class Laporan_logbook_out extends CI_Controller {
	...
	{						
		...
		$this->_render_page('laporan_logbook_out', $this->data);				
	}		
	...
	{	
		...
		foreach ($list as $list_item) {
			...
			if(! is_null($list_item->nama_posisi_penerima)){
				$jabatan = $list_item->nama_posisi_penerima;
			}elseif(! is_null($list_item->nama_group_penerima)){
