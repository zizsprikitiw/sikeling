...
class Tugas extends CI_Controller {
	...
	public function data_list()
	{
		...
		$search_column = array('nama','dari','ke','isi_tugas','status_tugas','tahun');
	...
	public function data_save_add()
	{
		...
		$this->form_validation->set_rules('isi_tugas', 'Isi Tugas', '');
        ...
        else
        {
			...
			if($select_tahun != '--Pilih--'){
				...
				/*	'file_laporan_tugas' => $_FILES["file_laporan_tugas"]["nama"], */
