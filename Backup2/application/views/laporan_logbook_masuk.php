  	...
  	<div class="mainbar" >      
		...
		<script type="text/javascript">		
			...
			function load_select_filter(){
				 $.ajax({
					url : "<?php echo site_url('laporan_logbook_masuk/data_init/')?>" ,
					type: "POST",
					dataType: "JSON",
			...
			$(document).ready(function() {								  			
				...
				$("#modalApproval").bind("hidden.bs.modal", function(e){
					...
					$.ajax({
							url : "<?php echo site_url('laporan_logbook_masuk/show_laporan_delete')?>",
							type: "POST",
							dataType: "JSON",
							data: form_data,
							success: function(data)
				...
				//load data table																
			 	table = $('#table').DataTable({ 			
					...
					"ajax": {
						"url": "<?php echo site_url('laporan_logbook_masuk/data_list')?>",
						"type": "POST",						
						"data": function ( d ) {
								var chkSearch = [];
			...
			{				 				
				...
				$.ajax({
					url : "<?php echo site_url('laporan_logbook_masuk/show_laporan')?>",
					type: "POST",
					dataType: "JSON",
					data: form_data,
					success: function(data)
			...
			function approval_laporan(id, nama, judul, logbook_id)
			{
				if(id != ''){
					...
					$.ajax({
						url : "<?php echo site_url('laporan_logbook_masuk/approval_laporan')?>/",
						type: "POST",
