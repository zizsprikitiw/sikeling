  	...
  	<div class="mainbar" >      
		...
		<script type="text/javascript">		
			...
			function load_select_filter(){
				 $.ajax({
					url : "<?php echo site_url('laporan_perjadin_keluar/data_init/')?>" ,
					type: "POST",
					dataType: "JSON",
			...
			$(document).ready(function() {								  			
				...
				$("#modalLaporan").bind("hidden.bs.modal", function(e){
					...
					$.ajax({
							url : "<?php echo site_url('laporan_perjadin_keluar/show_laporan_delete')?>",
							type: "POST",
							dataType: "JSON",
							data: form_data,
							success: function(data)
				...
				//load data table																
			 	table = $('#table').DataTable({ 			
					...
					"ajax": {
						"url": "<?php echo site_url('laporan_perjadin_keluar/data_list')?>",
						"type": "POST",						
						"data": function ( d ) {
								var chkSearch = [];
			...
			{				 				
				...
				$.ajax({
					url : "<?php echo site_url('laporan_perjadin_keluar/show_laporan')?>",
					type: "POST",
					dataType: "JSON",
					data: form_data,
					success: function(data)
			...
			{
				$.ajax({
					url : "<?php echo site_url('laporan_perjadin_keluar/data_edit_status')?>/"+id,
					type: "POST",
					dataType: "JSON",
					success: function(data)
					{
