  	...
  	<div class="mainbar" >      
		...
		<script type="text/javascript">		
			...
			function load_select_filter(){
				 $.ajax({
						url : "<?php echo site_url('rekap_lap_umum/data_init/')?>" ,
						type: "POST",
						dataType: "JSON",
			...
			$(document).ready(function() {								  			
				...
				load_select_filter();
				 ...
				 $("#modalLaporan").bind("hidden.bs.modal", function(e){
					...
					$.ajax({
							url : "<?php echo site_url('rekap_lap_umum/show_laporan_delete')?>",
							type: "POST",
							dataType: "JSON",
							data: form_data,
							success: function(data)
				...
				//load data table																
			 	table = $('#table').DataTable({ 			
					...
					"ajax": {
						"url": "<?php echo site_url('rekap_lap_umum/data_list')?>",
						"type": "POST",						
						"data": function ( d ) {
								var chkSearch = [];
			...
			{				 				
				...
				$.ajax({
						url : "<?php echo site_url('rekap_lap_umum/show_laporan')?>",
						type: "POST",
						dataType: "JSON",
						data: form_data,
						success: function(data)
			...
			function data_delete(id, nama_id)
			{
				if(id != ''){
					...
					$.ajax({
						url : "<?php echo site_url('rekap_lap_umum/data_delete')?>/",
						type: "POST",
